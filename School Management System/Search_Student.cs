    ...
    public partial class Search_Student : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string[] student = dm.FindStudent(searchBox.Text);
                ...
                btnEdit.Show();
                btnDelete.Show();
                btnBack.Location = new Point(455, 398);
                txtID.Show();
                txtName.Show();
                txtPassword.Show();
                txtCGPA.Show();
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            DatabaseManager db = new DatabaseManager();
            db.Update_Student(txtID.Text, txtName.Text, txtPassword.Text, gender, BGBox.Text, datePicker.Text, DepartmentBox.Text, txtCGPA.Text, txtGuardian.Text, txtContact.Text, txtEmail.Text, txtAddress.Text);
        }
        ...
        private void Search_Student_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
